...
| Gen_It-Tok    |    status     | reviewed     | n. sentences |
| ------------- | ------------- | ------------- |------------- |
|G0125_D   |OK| | 26 |
G1024_Q | OK| | 17 |
G1224_H| in progress| |
